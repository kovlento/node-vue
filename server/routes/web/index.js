module.exports = app => {
  ...
  router.get('/articles/:id',async(req,res)=>{
    ...
    router.get('/heroes/:id',async(req,res)=>{
      const data = await Hero.findById(req.params.id).populate('categories itemss itemsn partners.hero ').lean()
      res.send(data)
    })
